 ...
 */
export interface EditStoreShape {
  ...
  readonly list: () => Effect.Effect<ReadonlyArray<EditSummary>, StoreError>
 ...
 */
export class EditStore extends Context.Service<EditStore, EditStoreShape>()('EditStore') {}
