...
export const ChangedColumns = Message.m("ChangedColumns", {
  columns: S.Number,
});
/** The grid's explicit row count (docs/adr/0035) — an M×N grid, not count-derived. */
export const ChangedRows = Message.m("ChangedRows", { rows: S.Number });
...
export const ChangedFrameRatio = Message.m("ChangedFrameRatio", {
  frameRatio: S.Number,
});
...
export const ModeChanged = Message.m("ModeChanged", {
...
export const GotDragMessage = Message.m("GotDragMessage", {
...
export const PanMoved = Message.m("PanMoved", {
  screenX: S.Number,
  screenY: S.Number,
});
...
export const WheelZoomed = Message.m("WheelZoomed", {
  index: S.Number,
  deltaY: S.Number,
});
...
export const CollageExportSnapshotFailed = Message.m(
...
export const GotCollageExportDialogMessage = Message.m(
