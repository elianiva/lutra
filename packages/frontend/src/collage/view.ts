...
const controls = (h: HtmlBuilder<CollageMessage>, model: Model, collage: Collage) =>
  h.div(
    ...
    [
      ...
      h.div(
        ...
        [
          ...
          stepperButton(
            ...
            '−',
            'One fewer column',
            CollageMessage.ChangedColumns({ columns: Math.round(collage.layout.columns) - 1 }),
          ),
      ...
      h.div(
        [h.Class('flex items-center gap-2'), h.DataAttribute('control', 'rows')],
        [
          controlLabel(h, 'Rows'),
          stepperButton(
            h,
      ...
      h.div(
        ...
        [
          ...
          stepperButton(
            ...
            '−',
            'Smaller gutter',
            CollageMessage.ChangedGutter({ gutter: Math.round(collage.layout.gutter) - 8 }),
          ),
