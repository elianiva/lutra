...
// Parked here because the menu's primary action is "Edit Image", which
// starts the import flow owned by this feature. When image-editing lands
// and the menu becomes the launcher for multiple edit flows, extract
// this to its own features/main-menu/.
  ...
  return (
    <View className="flex-1 bg-background px-8">
      <View className="flex-1 items-center justify-center">
        <Text className="text-6xl tracking-tight font-sans">LUTRA</Text>
        ...
        <View className="mt-16 w-full max-w-xs gap-4">
          ...
          >
            {isPicking ? (
              ...
              <Text className="text-primary-foreground text-lg">Edit Image</Text>
            )}
          </Pressable>
          ...
          >
            <Text className="text-muted-foreground text-lg">Options</Text>
          </Pressable>
        </View>
      </View>
